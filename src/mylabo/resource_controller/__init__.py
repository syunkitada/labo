...
def load(ctx: context.Context, manifest: dict) -> resource.Resource:
    if manifest["kind"] in resource_class_map:
        return resource_class_map[manifest["kind"]](ctx, manifest)
