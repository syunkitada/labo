...
@fabric.task
def vm_image(c, task, context=".", tag="", debug=False, Dryrun=False):
    """vm-image [build] -c [spec_file] -t [tag] -d -D
...
def new_spec(name):
    ...
    image_src_yaml = os.path.join(image_src_dir, "image.yml")
    spec = {}
