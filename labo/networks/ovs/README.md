...
```
admin@local-vm1:~$ sudo docker exec clos1-HV1 ovs-appctl ofproto/trace br-int in_port=HV1_0_vm1,icmp,nw_src=10.100.0.2
...
```
admin@local-vm1:~$ sudo docker exec clos1-HV1 ovs-ofctl show br-int
