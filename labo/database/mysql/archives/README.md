...
- Master-Master 構成について
  - 2 つの Master で互いに Slave 設定を入れればよい
  - しかし、Master-Master の同時書き込みは不整合が発生しやすいので非推奨
...
- mysqldump に失敗する場合
  - データ量が多すぎて OOM で mysql がダウンする場合がある
    - innodb の buffer を割り当てすぎた場合など
